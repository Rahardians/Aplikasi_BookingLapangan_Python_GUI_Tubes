...
# Form implementation generated from reading ui file 'BList.ui'
#
        ...
        def tombol_showall(self): 
                ...
                for row_number,row_data in enumerate(result):
                    ...
                    for column_number,data in enumerate(row_data):
                        self.tabelpeserta.setItem(row_number,column_number,QtWidgets.QTableWidgetItem(str(data)))
...
"background-color: rgb(255, 255, 255)")
        ...
        "")
                ...
                self.label_2.setGeometry(QtCore.QRect(610, 160, 101, 32))
                font = QtGui.QFont()
                ...
                self.label_4.setGeometry(QtCore.QRect(610, 220, 121, 32))
                font = QtGui.QFont()
                font.setFamily("Times New Roman")
                font.setPointSize(12)
                font.setBold(True)
        ...
        "")
                ...
                self.label_7.setGeometry(QtCore.QRect(610, 400, 101, 32))
                font = QtGui.QFont()
                font.setFamily("Times New Roman")
                font.setPointSize(12)
                font.setBold(True)
        ...
        "")
                ...
                self.label_3.setGeometry(QtCore.QRect(870, 40, 121, 61))
                font = QtGui.QFont()
        ...
        "}")
                ...
                self.label_10.setPixmap(QtGui.QPixmap("../Images/editts.jpg"))
                self.label_10.setScaledContents(True)
                self.label_10.setObjectName("label_10")
                self.label_11 = QtWidgets.QLabel(self.centralwidget)
                self.label_11.setGeometry(QtCore.QRect(480, 20, 141, 32))
                font = QtGui.QFont()
                font.setFamily("Times New Roman")
                font.setPointSize(12)
                font.setBold(True)
